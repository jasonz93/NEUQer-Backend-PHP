 ...
 * Generated for Laravel 5.2.23 on 2016-03-26.
 *
...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function handle($input, $output = null){
            ...
            return \NEUQer\Console\Kernel::handle($input, $output);
        }
        ...
        public static function terminate($input, $status){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \NEUQer\Console\Kernel::terminate($input, $status);
        }
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \NEUQer\Console\Kernel::call($command, $parameters);
        }
        ...
        public static function queue($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \NEUQer\Console\Kernel::queue($command, $parameters);
        }
        ...
        public static function all(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \NEUQer\Console\Kernel::all();
        }
        ...
        public static function output(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \NEUQer\Console\Kernel::output();
        }
        ...
        public static function bootstrap(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \NEUQer\Console\Kernel::bootstrap();
        }
    ...
    class Utils extends \NEUQer\Facades\UtilsFacade{
        ...
        public static function microtimestamp(){
            return \NEUQer\Services\UtilService::microtimestamp();
        }
        
    }


    class WeixinPlatform extends \NEUQer\Facades\WeixinPlatformFacade{
         ...
         * @static 
         */
        public static function handleAuthorizationPush($signature, $timestamp, $nonce, $payload){
            return \NEUQer\Services\WeixinPlatformService::handleAuthorizationPush($signature, $timestamp, $nonce, $payload);
        }
        ...
        public static function generateAuthorizationUrl(){
            return \NEUQer\Services\WeixinPlatformService::generateAuthorizationUrl();
        }
         ...
         * @static 
         */
        public static function finishAuthorization($user, $authCode){
            return \NEUQer\Services\WeixinPlatformService::finishAuthorization($user, $authCode);
        }
        ...
        public static function getComponentAccessToken(){
            return \NEUQer\Services\WeixinPlatformService::getComponentAccessToken();
        }
        
    }


    class WeixinCrypto extends \NEUQer\Facades\WeixinCryptoFacade{
         ...
         * @static 
         */
        public static function encrtpyMsg($reply_msg, $timestamp, $nonce){
            return \NEUQer\SDK\Weixin\WXBizMsgCrtpy::encrtpyMsg($reply_msg, $timestamp, $nonce);
        }
         ...
         * @static 
         */
        public static function decryptMsg($msg_signature, $timestamp, $nonce, $encryptedXml){
            return \NEUQer\SDK\Weixin\WXBizMsgCrtpy::decryptMsg($msg_signature, $timestamp, $nonce, $encryptedXml);
        }
    ...
    class Turing extends \NEUQer\Facades\TuringFacade{
         ...
         * @static 
         */
        public static function send($content, $username){
            return \NEUQer\Services\TuringService::send($content, $username);
        }

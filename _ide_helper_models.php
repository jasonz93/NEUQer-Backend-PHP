 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\NEUQer\WeixinEventHandler[] $eventHandler
 ...
 * @method static \Illuminate\Database\Query\Builder|\NEUQer\User whereOldpwd($value)
 */
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\NEUQer\BBSReply[] $comments
 ...
 * @method static \Illuminate\Database\Query\Builder|\NEUQer\BBSTopic whereFloors($value)
 */
...
namespace NEUQer{
/**
 * NEUQer\WeixinEventHandler
 *
 * @property integer $id
 * @property string $mp_app_id
 * @property string $name
 ...
 * @property \Carbon\Carbon $updated_at
 * @property-read \NEUQer\Wx3rdMP $mp
 * @method static \Illuminate\Database\Query\Builder|\NEUQer\WeixinEventHandler whereId($value)
 * @method static \Illuminate\Database\Query\Builder|\NEUQer\WeixinEventHandler whereMpAppId($value)
 * @method static \Illuminate\Database\Query\Builder|\NEUQer\WeixinEventHandler whereName($value)
 * @method static \Illuminate\Database\Query\Builder|\NEUQer\WeixinEventHandler whereParams($value)
 * @method static \Illuminate\Database\Query\Builder|\NEUQer\WeixinEventHandler wherePriority($value)
 * @method static \Illuminate\Database\Query\Builder|\NEUQer\WeixinEventHandler whereCreatedAt($value)
 * @method static \Illuminate\Database\Query\Builder|\NEUQer\WeixinEventHandler whereUpdatedAt($value)
 */
	class WeixinEventHandler extends \Eloquent {}
}
